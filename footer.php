...
<section class="fullwidth-layout">
        <div class="footer-top">
            <div class="container footer-top-content">
                ...
                <ul class="social-media-footer">
                    <li><a href="https://api.whatsapp.com/send?phone=6287758532425&text=Halo,%20Anang%20Wahyu%20Pradana"><i class="fab fa-whatsapp"></i></a></li>
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD2GA8PB8r4KQzFKAlA8Ps53igW6IvN4Ks&callback=initMap&v=3"
