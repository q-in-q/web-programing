...
<div class="container">
    <div class="main-promo-detail text-center">
        <img src="./assets/img/Promo-Domain-ID-Juni-2019-IDCloudHost.jpg" alt="">
        ...
        <div class="row">
                <div class=" col-sm-4">
                    <div class="card-main img-box">
                        <img class="card-img-top img-responsive" src="./assets/img/Promo-Domain-ID-Juni-2019-IDCloudHost.JPG" alt="Card image cap">
                        <div class="text-view">
                            <ul>
